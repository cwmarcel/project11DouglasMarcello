...
public class Main extends Application {
    ...
    @Override public void start(Stage stage) throws Exception {
        ...
        // configure the stage
        stage.setTitle("project11DouglasMarcello's Project 10");
        stage.sizeToScene();
        stage.setScene(scene);
        stage.setOnCloseRequest(event -> ((project11DouglasMarcello.Controller)loader.getController()).handleExitAction(event));
        stage.show();
    }
