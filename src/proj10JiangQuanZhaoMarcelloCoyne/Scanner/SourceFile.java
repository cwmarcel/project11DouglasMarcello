...
class SourceFile {
    ...
    /**
     * Creates a new SourceFile object for the file with a given reader stream.
     *
     * @param in an input Reader stream
     */
    SourceFile(Reader in) {
        this.sourceReader = in;
        this.currentLineNumber = 1;
        this.prevChar = -1;
    }
    ...
    /**
     * Gets the current character of the file
     * @return the current character
     */
    public char getCurrentChar() {
        return (char) this.prevChar;
    }
