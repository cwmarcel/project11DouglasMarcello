...
public class Main extends Application {
    ...
    @Override public void start(Stage stage) throws Exception {
        ...
        // configure the stage
        stage.setTitle("proj9JiangQuanZhaoMarcelloCoyne's Project 9");
        stage.sizeToScene();
        stage.setScene(scene);
        stage.setOnCloseRequest(event -> ((proj10JiangQuanZhaoMarcelloCoyne.Controller)loader.getController()).handleExitAction(event));
        stage.show();
    }
