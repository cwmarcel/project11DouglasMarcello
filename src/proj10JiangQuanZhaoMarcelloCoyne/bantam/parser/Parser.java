            ...
            default:
                ...
                if (!currentToken.spelling.equals("(")) {//not dispatch
                    if (!currentToken.spelling.equals("[")) {//not array member
                        ...
                        this.currentToken = scanner.scan();
                        if(!this.currentToken.spelling.equals("]")){
                            this.errorHandler.register(Error.Kind.PARSE_ERROR, null, position, "Missing Right Brackets");
                        }
                    }
                    ...
                    if(!this.currentToken.spelling.equals((")"))){
                        this.errorHandler.register(Error.Kind.PARSE_ERROR, null, position, "Missing Right Parenthese");
                    }
